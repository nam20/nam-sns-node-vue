          ...
          <v-card>
              <v-form>
                  <v-container>
                      ...
                      <!-- <a href="http://35.237.143.228/auth/facebook" style="text-decoration-line: none;"><v-btn >페북</v-btn></a>
                      <a href="http://35.237.143.228/auth/google" style="text-decoration-line: none;"><v-btn >구글</v-btn></a> -->
                      <a href="http://35.237.143.228/auth/kakao" style="text-decoration-line: none;"><v-btn >카카오</v-btn></a>
                      <a href="http://35.237.143.228/auth/naver" style="text-decoration-line: none;"><v-btn >네이버</v-btn></a>
